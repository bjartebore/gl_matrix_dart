...
/// @returns {vec4} a new 4D vector
List<double> fromValues(double x, double y, double z, double w) {
  final out = <double>[];
  out[0] = x;
  out[1] = y;
  out[2] = z;
...
/// @param {Number} w W component
/// @returns {vec4} out
List<double> set(List<double> out, double x, double y, double z, double w) {
  out[0] = x;
  out[1] = y;
  out[2] = z;
  out[3] = w;
